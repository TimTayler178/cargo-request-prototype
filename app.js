...
document.addEventListener('keydown',event=>{if(event.key==='Escape'){if(!modal.hidden)closeModal();$$('.route-action.open,.ds-select.open').forEach(x=>x.classList.remove('open'))}});
